...
# - https://github.com/zmkfirmware/zmk/pull/2045
#
# This outputs battery levels for connected bluetooth devices.
# It supports devices with multiple batteries, such as a zmk split keyboard.

DBUS_CONN="org.bluez"
DBUS_PATHS=("/org/bluez/hci0" "/org/bluez/hci1") # you probably want to use hci0 only
